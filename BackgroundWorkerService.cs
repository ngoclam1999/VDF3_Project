...
public class BackgroundWorkerService
{
    ...
    //public ActUtlType PLCQ03UDE = new ActUtlType();
    ...
    private void Worker_DoWork(object sender, DoWorkEventArgs e)
    {
        ...
        while (!_worker.CancellationPending)
        {
            if (VariableRobot.RobotType == 1)
            {
                ...
                if (_modbusClient == null && VariableRobot.RobotType == 1)
                {
                ...
                try
                {
                    ...
                    float RobotX = ModbusClient.ConvertRegistersToFloat(_modbusClient.ReadInputRegisters(50, 2));
                    ...
                    float RobotY = ModbusClient.ConvertRegistersToFloat(_modbusClient.ReadInputRegisters(52, 2));
                    if (RobotY != null)
                    {
                        // Giả sử VariableRobot là biến toàn cục hoặc thuộc tính của một lớp khác
                    ...
                    _modbusClient.WriteSingleRegister(58, 2);
                    _modbusClient.WriteMultipleRegisters(60, ConvertFloatToRegisters(123.45f));
                    _modbusClient.WriteMultipleRegisters(62, ConvertFloatToRegisters(434.56f));
                    _modbusClient.WriteMultipleRegisters(64, ConvertFloatToRegisters(12.5f));
                    _modbusClient.WriteMultipleRegisters(66, ConvertFloatToRegisters(123.45f));
                    _modbusClient.WriteMultipleRegisters(68, ConvertFloatToRegisters(434.56f));
                    _modbusClient.WriteMultipleRegisters(70, ConvertFloatToRegisters(12.5f));
